              ...
              <div class="tab-wrapper">
                  <my-tab-container class="page-tabbar-tab-container" v-model="active" :swipeable = "swipeable" @end-move="endMove" @start-move="startMove" >
                      <mt-tab-container-item id="tab-container1">
                          ...
                          <div class="moments-scroll" v-show="data.tab1.loaded" style="overflow: hidden;">
                      ...
                      <mt-tab-container-item id="tab-container2">
                          <div class="moments-scroll" v-show="data.tab2.loaded" style="overflow: hidden;">
                      ...
                      <mt-tab-container-item id="tab-container3">
                          <div class="moments-scroll" v-show="data.tab3.loaded" style="overflow: hidden;">
  ...
  import share from '../components/share.vue'
    ...
    export default {
        ...
        methods:{
          ...
          loadTop() {
            this.tabstate[this.tabIndex(this.active)] = false;
            this.init();  
